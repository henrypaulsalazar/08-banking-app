import { depositFromBranch } from '../../../../../src/app/core/services/user/depositFromBranch.service';
...
describe('depositFromBranch', () => {
  it('should handle errors when deposit from branch fails', async () => {
    ...
    const result = await depositFromBranch(1000, '12345', 'customer1', '67890', mockToken);
  ...
  it('should call encryptAES for account numbers and customer correctly', async () => {
    ...
    await depositFromBranch(1000, '12345', 'customer1', '67890', mockToken);
