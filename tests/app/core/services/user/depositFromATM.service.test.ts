import { depositFromATM } from '../../../../../src/app/core/services/user/depositFromATM.service';
...
describe('depositFromATM', () => {
  it('should handle errors when deposit fails', async () => {
    ...
    const result = await depositFromATM(1000, '12345', 'customer1', '67890', mockToken);
  ...
  it('should call encryptAES for account numbers and customer correctly', async () => {
    ...
    await depositFromATM(1000, '12345', 'customer1', '67890', mockToken);
