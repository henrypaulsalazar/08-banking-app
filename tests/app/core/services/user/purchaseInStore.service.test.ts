import { purchaseInStore } from '../../../../../src/app/core/services/user/purchaseInStore.service';
...
describe('purchaseInStore', () => {
  it('should handle errors when purchase in store fails', async () => {
    ...
    const result = await purchaseInStore(1000, '12345', 'customer1', mockToken);
  ...
  it('should call encryptAES for account number and customer correctly', async () => {
    ...
    await purchaseInStore(1000, '12345', 'customer1', mockToken);
