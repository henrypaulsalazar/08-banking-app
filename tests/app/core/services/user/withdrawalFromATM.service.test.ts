import { withdrawalFromATM } from '../../../../../src/app/core/services/user/withdrawalFromATM.service';
...
describe('withdrawalFromATM', () => {
  it('should handle errors when withdrawal from ATM fails', async () => {
    ...
    const result = await withdrawalFromATM(1000, '12345', 'customer1', mockToken);
  ...
  it('should call encryptAES for account number and customer correctly', async () => {
    ...
    await withdrawalFromATM(1000, '12345', 'customer1', mockToken);
